...
class MergeVideoVC: UIViewController {
  ...
  @IBAction func merge(_ sender: AnyObject) {
    ...
    // 2.2
    let firstInstruction = VideoHelper.firstVideoCompositionInstruction(firstTrack, asset: firstAsset)
    firstInstruction.setOpacity(0.0, at: firstAsset.duration)
    let secondInstruction = VideoHelper.secondVideoCompositionInstruction(secondTrack, asset: secondAsset)
